...
import static com.example.doctor_patient_management_system.model.enumeration.Role.*;
...
//    http
//            .csrf(csrf -> csrf.disable()) // JWT doesn't need CSRF protection
//
