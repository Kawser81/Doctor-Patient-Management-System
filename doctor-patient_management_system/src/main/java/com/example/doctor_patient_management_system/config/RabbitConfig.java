...
//    @Bean
//    public Queue patientRegisterQueue() {
//        return new Queue("patient.register.queue", true);  // Durable: true
//    }
//
//    @Bean
//    public Queue doctorRegisterQueue() {
//        return new Queue("doctor.register.queue", true);
//    }
//
//    // Queue for booking
//    @Bean
//    public Queue appointmentBookQueue() {
//        return new Queue("appointment.book.queue", true);
//    }
//
//    // Exchange (Direct type for simple routing)
//    @Bean
//    public DirectExchange exchange() {
//        return new DirectExchange("registration.booking.exchange");
//    }
//
//    // Bindings: Queue to Exchange with routing key
//    @Bean
//    public Binding patientRegisterBinding(Queue patientRegisterQueue, DirectExchange exchange) {
//        return BindingBuilder.bind(patientRegisterQueue).to(exchange).with("patient.register");
//    }
//
//    @Bean
//    public Binding doctorRegisterBinding(Queue doctorRegisterQueue, DirectExchange exchange) {
//        return BindingBuilder.bind(doctorRegisterQueue).to(exchange).with("doctor.register");
//    }
//
//    @Bean
//    public Binding appointmentBookBinding(Queue appointmentBookQueue, DirectExchange exchange) {
//        return BindingBuilder.bind(appointmentBookQueue).to(exchange).with("appointment.book");
//    }
//
//    // Message Converter (JSON for complex objects)
//    @Bean
