...
public class MessageOutboxScheduler {
    ...
    private static final Logger log = LoggerFactory.getLogger(MessageOutboxScheduler.class);
    private static final int MAX_RETRIES = 5;

    private final MessageOutboxRepository outboxRepository;
    private final RabbitProducerService producerService;

    public MessageOutboxScheduler(MessageOutboxRepository outboxRepository,
    ...
    /**
     * Process pending messages every 10 seconds
     */
        ...
        try {
            ...
            for (MessageOutbox message : pendingMessages) {
                ...
                if (sent) {
                    ...
                    log.warn("⚠️ Message failed: ID={}, Retry={}/{}",
